...
- `entity/` — Base entity class (`CasaITSmartHomeEntity`)
...
- Entity MRO: `(PlatformEntity, CasaITSmartHomeEntity)` — order matters
...
- Debug level: `custom_components.casait_smarthome: debug` in `config/configuration.yaml`
