...
- `CasaITSmartHomeApiClientError` (Base)
- `CasaITSmartHomeApiClientCommunicationError` (Network, timeout, HTTP errors)
- `CasaITSmartHomeApiClientAuthenticationError` (401, 403, invalid credentials)
