...
- **`entity/`** - Base entity classes (inherit `CasaITSmartHomeEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, CasaITSmartHomeEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import CasaITSmartHomeEntity`
